...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	function getDynamicConfiguration(){
		...
		$conf['general']['sitename'] = 'SymCommunity Ensemble';
		...
		$conf['members']['section'] = '2';
		$conf['members']['reset-password-auto-login'] = '';
		$conf['members']['regenerate-activation-code-template'] = 'etm-send-activation-code';
